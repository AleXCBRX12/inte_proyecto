...
urlpatterns = [
    ...
    path("recursos/", views.recursos_usuario, name="recursos_usuario"),
    path("recursos/descargar/<str:id>/", views.recurso_descargar_usuario, name="recurso_descargar_usuario"),
