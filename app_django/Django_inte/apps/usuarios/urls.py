...
urlpatterns = [
    ...
    path("notificaciones/api/unread-count/", views.notificaciones_unread_count_api, name="notificaciones_unread_count_api"),
    path("notificaciones/api/read-all/", views.notificaciones_read_all_api, name="notificaciones_read_all_api"),
    path("notificaciones/api/<str:notif_id>/read/", views.notificaciones_read_one_api, name="notificaciones_read_one_api"),
